 ...
 * @param options.num the number you want to transfer
 * @param options.len the output array length, default length of num
 * @param options.fill how would you like to fill the empty indexes, default empty string
 */
