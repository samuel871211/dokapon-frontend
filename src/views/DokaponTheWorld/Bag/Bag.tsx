    ...
    >
      <div
        className={classNames(
          `${styles.topArea}`,
          `${transitionStyles.topArea[state]}`
        )}
      >
      ...
      <div
        className={classNames(
          `${styles.centerArea}`,
          `${transitionStyles.centerArea[state]}`
        )}
      >
        <div className={styles.itemAndMagicContainer}>
          ...
          >
            <Item
              selected={curBag === "item" && selectedItemIdx === 0}
              text={bagInfo.item[0]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 1}
              text={bagInfo.item[1]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 2}
              text={bagInfo.item[2]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 3}
              text={bagInfo.item[3]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 4}
              text={bagInfo.item[4]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 5}
              text={bagInfo.item[5]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 6}
              text={bagInfo.item[6]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "item" && selectedItemIdx === 7}
              text={bagInfo.item[7]}
              icon={<SomeKindOfIcon />}
            />
          </div>
          ...
          >
            <Item
              selected={curBag === "magic" && selectedItemIdx === 0}
              text={bagInfo.magic[0]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 1}
              text={bagInfo.magic[1]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 2}
              text={bagInfo.magic[2]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 3}
              text={bagInfo.magic[3]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 4}
              text={bagInfo.magic[4]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 5}
              text={bagInfo.magic[5]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 6}
              text={bagInfo.magic[6]}
              icon={<SomeKindOfIcon />}
            />
            <Item
              selected={curBag === "magic" && selectedItemIdx === 7}
              text={bagInfo.magic[7]}
              icon={<SomeKindOfIcon />}
            />
          </div>
        </div>
            ...
            {(state) => (
              <div
                className={classNames(
                  ...
                  transitionStyles.confirmDialog[state]
                )}
              ></div>
            )}
          </Transition>
